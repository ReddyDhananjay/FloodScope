...
export function setupAuth(app) {
  ...
  const authReady = !!GOOGLE_CLIENT_ID && !!GOOGLE_CLIENT_SECRET;
  if (!authReady) {
    console.log('  ⚠️  Google OAuth not configured. Email/password auth is still active.');
  }
  return true; // always true now — local auth works
}
